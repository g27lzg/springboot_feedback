...
public class ArticleController {
    ...
    public String index(ModelMap map, HttpServletRequest req, Content content) {
...
//        contentQuery.setTitle("2");
        Page<Content> linksPage = contentQueryService.findContentCriteria(page, size, content);
